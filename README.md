...
### Online Learning
In this approach the model is fed either small groups of samples called *mini-batches* or individual data instances. The model learns continuesly. It is cheaper and faster to train a model like this 
